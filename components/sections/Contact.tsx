// Contact — Phase 4: Scroll reveals added.
// Heading: fade-up. Links: fade-in with 50 ms stagger.
  ...
  return (
    ...
    >
      <div className="container-bp section-spacing">
        ...
        >
          {LINKS.map(({ id, label, href, display, primary }, i) => (
            <Reveal key={id} variant="fade-in" delay={0.1 + i * 0.05}>
              <a
                id={`contact-link-${id}`}
                href={href}
